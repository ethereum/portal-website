...
The Glados monitor continually follows the tip of the Ethereum blockchain and computes Portal Network content keys for each new block.
...
You can **run a Glados dashboard locally** by following instructions on the [Glados Github](https://github.com/ethereum/glados/blob/master/SETUP_GUIDE.md).